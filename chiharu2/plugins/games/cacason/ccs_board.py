...
class Board:
    ...
    def saveImg(self):
        ...
        with open(img(name), 'rb') as f:
            ...
            return MessageSegment.attachment(File(content=f.read(), filename=name))
